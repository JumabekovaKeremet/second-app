...
import Massive from "./components/Massve/Massive";
function App() {
  const persons = [
      ...
      { name: "Nurkys", role: "Student", wpm: 39, commits: 26 },
      ...
      { name: "Aiymkys", role: "Student", wpm: 37, commits: 226 },
      { name: "Keremet", role: "Student", wpm: 41, commits: 999 },
      { name: "Karylgach", role: "Student", wpm: 25, commits: 66 },
    ...
    const output =  persons.map(persons => <Massive {...person}/>);
  return (
    <div className="App">
    </div>
  );
